...
# setting up grid search
grid_search_svm = GridSearchCV(estimator=pipeline_svm, param_grid=param_grid_svm, cv=5, scoring='accuracy', verbose=1)

# setting up random grid search
random_search_svm = RandomizedSearchCV(estimator=pipeline_svm, param_distributions=param_dist_svm, n_iter=20, cv=5, scoring='accuracy', verbose=1, random_state=42)
...
# randomizedsearchcv params
param_dist_nn = {
    'classifier__hidden_layer_sizes': [(randint(50, 100).rvs(),), (randint(100, 200).rvs(),)],
    'classifier__activation': ['tanh', 'relu'],
    'classifier__solver': ['sgd', 'adam'],
...
# setting up random grid search
random_search_nn = RandomizedSearchCV(estimator=pipeline_nn_grid, param_distributions=param_dist_nn, n_iter=20, cv=5, scoring='accuracy', verbose=1, random_state=42)
